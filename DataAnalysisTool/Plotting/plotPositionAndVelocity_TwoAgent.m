function plotPositionAndVelocity_TwoAgent(agent,plt_stuff)
...
leg_pos = legend({'$q_1$','$q_2$','$q_g + R d_i$'},'Orientation','horizontal');%,'$q_2$','$q_g + R^{\rm T}d_2$','$q_3$','$q_g + R^{\rm T}d_3$');
legend boxoff
...
leg_pos = legend({'$p_1$','$p_2$','$p_g + R \Omega d_i$'},'Orientation','horizontal');%,'$q_2$','$q_g + R^{\rm T}d_2$','$q_3$','$q_g + R^{\rm T}d_3$');
legend boxoff
set(leg_pos,'interpreter','latex','Location','NorthEast','FontSize',plt_stuff.leg_fsize)
grid on
xlim([startTime, endTime])
