function plotPositionAndVelocity_ThreeAgent(agent,plt_stuff)

disp('Plotting R2T Position and Velocity')
...
plot(agent(1).time(plt_stuff.plot_index),agent(1).pos_3(plt_stuff.plot_index,1),'g','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_1(1,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_2(1,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_3(1,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
hold off
...
plot(agent(1).time(plt_stuff.plot_index),agent(1).pos_3(plt_stuff.plot_index,2),'g','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_1(2,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_2(2,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_3(2,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
hold off
...
plot(agent(1).time(plt_stuff.plot_index),agent(1).pos_3(plt_stuff.plot_index,3),'g','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_1(3,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_2(3,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_3(3,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
hold off
...
plot(agent(1).time(plt_stuff.plot_index),agent(1).vel_3(plt_stuff.plot_index,1),'g','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_1(1,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_2(1,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_3(1,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
hold off
...
plot(agent(1).time(plt_stuff.plot_index),agent(1).vel_3(plt_stuff.plot_index,2),'g','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_1(2,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_2(2,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_3(2,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
hold off
...
plot(agent(1).time(plt_stuff.plot_index),agent(1).vel_3(plt_stuff.plot_index,3),'g','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_1(3,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_2(3,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
plot(agent(1).time(plt_stuff.plot_index),agent(1).R2T.R2T_dot_3(3,plt_stuff.plot_index),'k --','linewidth',plt_stuff.lval)
hold off
xlabel('$t$~(s)','interpreter','latex','FontSize',plt_stuff.fsize)
