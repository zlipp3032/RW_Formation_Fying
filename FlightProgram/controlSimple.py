...
#        print(self.stateVehicles[2].timestamp)
	...
	# If k0 = 0 && k1 = wc ---> then this is a standard low pass filter (e.g., no extra weight on the desired state)
	...
	des_vel = gains['k0_lp_mid'] * pd
	# Compute the first-order low pass filter
	val = filter_weight * (des_vel + vel_error) + gamma_mid * val_prev
	return val
