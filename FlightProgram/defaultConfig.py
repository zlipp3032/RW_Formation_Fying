...
def getParams():
    ...
    defaultParams.gains = {'intGain': 0.1, 'velGain': 0.1, 'attRate': 0.2, 'yawP': 1.0, 'mid_loop_converge': 0.01, 'att_settle_time': 7.0, 'mid_vel_scale': 1500.0,
			   ...
			   'ku_vel_pid': 2.5, 'kv_vel_pid': 2.5, 'kw_vel_pid': 1.5, # Middle-loop velocity controller gains for the PID controller
                           ...
                           'ku_vel_form': 1.0, 'kv_vel_form': 1.0, 'kw_vel_form': 1.5, # Middle-Loop velocity controller gains for the Formation controller
                           'alpha12': 0.12, 'beta12': 1.0, 'gammaX': 0.144, 'etaX': 1.2, # R2T gains
			   'alpha23': 0.12, 'beta23': 1.0, 'gammaY': 0.144, 'etaY': 1.2, # R2T gains
			   'alphaZ': 0.117, 'betaZ': 0.9, 'gammaZ': 0.182, 'etaZ': 1.4, # R2T gains
